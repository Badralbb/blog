      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-2 w-full mx-auto md:grid-cols-3 mb-10">
          {articles.map((item) => (
            <div
              key={item.id}
              className="p-4 max-w-[396px] mx-auto w-full hover:rotate-[-20deg] transition-[5s] border-[1px] border-solid border-[#E8E8EA] hover:cursor-pointer rounded-xl shadow-lg drop-shadow-[0_35px_35px_purple]"
            >
